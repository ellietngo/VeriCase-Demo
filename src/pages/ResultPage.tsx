      ...
      <main className="relative z-10 flex-1 flex flex-col justify-center px-4 py-12 md:px-8 md:py-16">
        <div className="w-full max-w-sm mx-auto md:max-w-2xl">
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div
              className="h-1.5"
              style={{ background: isCitizen ? 'linear-gradient(90deg, #008000, #1a7a40)' : 'linear-gradient(90deg, #00416A, #1460AA)' }}
              aria-hidden="true"
            />
            ...
            <div className="p-8 md:p-10 md:grid md:grid-cols-[auto_1fr] md:gap-10 md:items-start">
              ...
              <div>
                ...
                <h1 className="text-2xl md:text-3xl font-extrabold text-[#222222] text-center md:text-left mb-4">
                ...
                <p className="text-sm md:text-base text-[#555555] text-center md:text-left leading-relaxed mb-5">
                  {isCitizen
                ...
                {!isCitizen && (
                  <div className="flex justify-center md:justify-start mb-5">
                    <a
                      ...
                      className="text-sm text-cbp-blue font-medium hover:underline focus:outline-none focus:underline"
                    >
                ...
                <div className="border-t border-[#EEEEEE] pt-5 flex flex-col sm:flex-row gap-3">
                  <button
                    onClick={() => navigate('/verify')}
                    className="flex-1 flex items-center justify-center gap-2 border-2 border-[#EEEEEE]
                      text-[#333333] font-semibold py-3 rounded-2xl
                  ...
                  <Link
                    to="/"
                    className="flex-1 flex items-center justify-center gap-2 bg-cbp-navy text-white
                      font-semibold py-3 rounded-2xl hover:bg-[#003558] transition-colors
