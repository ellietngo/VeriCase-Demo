...
const SOURCES: { category: string; items: Source[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: '8 U.S.C. § 1186a — Conditional permanent resident status', url: 'https://uscode.house.gov/view.xhtml?req=title:8+section:1186+edition:prelima', description: 'Two-year conditional residence for marriage-based green card holders; basis for Form I-751/I-829.' },
      ...
      { title: '8 U.S.C. § 1229b — Cancellation of removal', url: 'https://uscode.house.gov/view.xhtml?req=title:8+section:1229+edition:prelimb', description: 'Discretionary relief from removal available in immigration court proceedings.' },
      { title: '8 U.S.C. § 1254a — Temporary Protected Status', url: 'https://uscode.house.gov/view.xhtml?req=title:8+section:1254+edition:prelima', description: 'TPS country designation, eligibility, and Form I-821 filing basis.' },
